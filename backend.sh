...
mount -t nfs 192.168.6.13:/var/www/html /var/www/html

# Añadir entrada al /etc/fstab para montaje persistente
echo "192.168.6.13:/var/www/html /var/www/html nfs defaults 0 0" >> /etc/fstab
...
server {
    ...
    location ~ \.php\$ {
        ...
        fastcgi_pass 192.168.6.13:8080;
